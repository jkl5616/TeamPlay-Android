...
import skku.teamplay.activity.test.KanbanBoardTestActivity;
        import skku.teamplay.activity.test.TeamDisplay;
...
public class Constants {
    ...
    public static final Class[] ACTIVITES = {MainActivity.class, ChartTestActivity.class, KanbanBoardTestActivity.class, ViewPagerTestActivity.class, UserProfileActivity.class, TeamDisplay.class};
