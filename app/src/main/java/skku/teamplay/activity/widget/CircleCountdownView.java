...
public class CircleCountdownView extends FrameLayout {
    ...
    private void init(Context ctx) {
        View rootView = inflate(ctx, R.layout.layout_countdown_view, this);
...
//
//        LayerDrawable progressBarDrawable = (LayerDrawable) progressBarView.getProgressDrawable();
//        Drawable backgroundDrawable = progressBarDrawable.getDrawable(0);
//        Drawable progressDrawable = progressBarDrawable.getDrawable(1);
//
//        backgroundDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorPrimaryDark), PorterDuff.Mode.SRC_IN);
//        backgroundDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorAccent), PorterDuff.Mode.SRC_IN);
    }
